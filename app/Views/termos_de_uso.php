    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-4">
          ...
          <li class="nav-item"><a class="nav-link gda_nav_active" href="<?= base_url('termos-de-uso') ?>">Termos de Uso</a></li>
          <li class="nav-item"><a class="nav-link" href="<?= base_url('politica-de-privacidade') ?>">Política de Privacidade</a></li>
        </ul>

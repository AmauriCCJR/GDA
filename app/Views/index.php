...
<body>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-12">
          ...
          <div class="d-flex gap-2 flex-wrap">
            ...
            <a class="btn btn-outline-success" href="<?= base_url('solicitar-acesso') ?>">Saiba Mais</a>
          </div>
        </div>
  ...
  <div class="container-fluid">
    <section class="container mt-5 mb-5 p-2" id="depoimento">
  ...
  <div class="container">
    <div class="row" id="planos">
      <section class="planos text-center py-2 p-2">
        <div class="row">
          <h2 class="planos_title">Planos que Crescem com seu negócio</h2>

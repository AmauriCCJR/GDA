  ...
  <header class="gda-topbar">
    ...
    <div class="gda-topbar-user">
      <div class="gda-topbar-user-info">
        <div class="gda-topbar-user-name">Funcionário</div>
        <div class="gda-topbar-user-email">admin@gda.com.br</div>
      </div>
      <a href="index.php">
      <div class="gda-avatar">F</div>
      </a>
  </header>

  <!-- TABS -->
  <div class="gda-tabs-bar">
    <a href="dashboard_funcionario.php" class="gda-tab active">
      ...
      <div class="col-lg-4 col-md-6 col-12">
        <div class="gda-panel">
          ...
          <div class="gda-top-item">
            <div class="gda-top-item-left"><span class="gda-dot-green"></span> Gesad</div>
            <span class="gda-top-badge">23</span>
          </div>
          <div class="gda-top-item">
            <div class="gda-top-item-left"><span class="gda-dot-green"></span> ComexAgro</div>
            <span class="gda-top-badge">17</span>
          </div>
          <div class="gda-top-item">
            <div class="gda-top-item-left"><span class="gda-dot-green"></span> InfraEx</div>
      ...
      <div class="col-lg-4 col-md-12 col-12">
        <div class="gda-panel">
          ...
          <div class="gda-status-item">
            <div class="d-flex align-items-center gap-2"><span class="gda-dot-green"></span> Concluído</div>
            <span class="gda-status-count">33</span>
          </div>
          <div class="gda-status-item">
            <div class="d-flex align-items-center gap-2"><span class="gda-dot-yellow"></span> Em andamento</div>
            <span class="gda-status-count">17</span>
          </div>
          <div class="gda-status-item">
            <div class="d-flex align-items-center gap-2"><span class="gda-dot-red"></span> Cancelado</div>
